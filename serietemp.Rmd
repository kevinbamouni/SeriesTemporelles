...
ggsdc(dfgazolezoo, aes(x = x, y = gazolezoo), method = "decompose", frequency = frequency(gazolezoo),
      facet.titles = c("Série temporelle de Vente de gazole en kt", "Le trend de la série", "", "Période de la série","Résidus aléatoires")) + geom_line()
```
...
ggsdc(dfgazolezoo, aes(x = x, y = gazolezoo), method = "seas", frequency = frequency(gazolezoo),
...
ggsdc(dfgazolezoo, aes(x = x, y = gazolezoo), method = "stl", frequency = frequency(gazolezoo), s.window = "periodic", facet.titles = c("Série temporelle de Vente de gazole en kt", "Le trend de la série", "Saisonnalité de la série","Résidus aléatoires")) + geom_line()
...
dfsuperzoo = as.data.frame(superzoo, row.names = c(1:length(superzoo))) # Conversion en dataframe
dfsuperzoo[,"x"]= dates # Insersion d'indice

# Creates a four-facet plot of seasonal decomposition showing observed, trend, seasonal and random components
# frequency	= frequency of the period of the time series eg 12 = monthly

ggsdc(dfsuperzoo, aes(x = x, y = superzoo), method = "decompose", frequency = frequency(superzoo),
...
# Autocorrelogrammes et autocorrelogrammes partielles
